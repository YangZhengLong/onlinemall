...
public class CartController {
    ...
    public ServerResponse<CartVo> select(HttpSession session,Integer productId){
        ...
        return iCartService.selectOrUnSelectOne(user.getId(),productId,Const.Cart.CHECKED);
    }
    ...
    public ServerResponse<CartVo> unSelect(HttpSession session,Integer productId){
        ...
        return iCartService.selectOrUnSelectOne(user.getId(),productId,Const.Cart.UNCHECKED);
    }

    //查询用户购物车中产品数量，如果一个产品有10个，那个数量就是10
