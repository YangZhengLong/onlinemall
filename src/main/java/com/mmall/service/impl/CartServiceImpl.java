 ...
 * @Description CartService Implementation
 * @Author Yang Zhenglong
 * @Date 2019/7/25 12:08
 * @Vesion 1.0
 */
...
public class CartServiceImpl implements ICartService {
    ...
    public ServerResponse<CartVo> add(Integer userId,Integer productId,Integer count){
        ...
        Cart cart = cartMapper.selectCartByUserIdAndProuctId(userId,productId);
        if(cart == null){
            //这个产品不在购物车内，需要新增一个这个产品的记录
    ...
    public ServerResponse<CartVo> selectOrUnSelectAll(Integer userId, Integer checked){
        cartMapper.checkedOrUnCheckedAllProduct(userId,null,checked);
        return this.list(userId);
    }
        ...
        if(CollectionUtils.isNotEmpty(cartList)){
            for(Cart cartItem:cartList){
                ...
                if(product != null){
                    ...
                    cartProductVo.setSunbTitle(product.getSubtitle());
                    ...
                    cartProductVo.setProductChedked(cartItem.getChecked());
                }
